(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/forms'), require('@angular/router'), require('@angular/common'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/platform-browser/animations')) :
    typeof define === 'function' && define.amd ? define('angular-bootstrap-md', ['exports', '@angular/animations', '@angular/forms', '@angular/router', '@angular/common', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/platform-browser/animations'], factory) :
    (factory((global['angular-bootstrap-md'] = {}),global.ng.animations,global.ng.forms,global.ng.router,global.ng.common,global.ng.core,global.rxjs,global.rxjs.operators,global.ng.platformBrowser.animations));
}(this, (function (exports,animations,forms,router,common,i0,rxjs,operators,animations$1) { 'use strict';
